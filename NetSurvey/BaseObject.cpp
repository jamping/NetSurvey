...
void CBaseObject::ShowListCtrl(CListCtrlEx* pListCtrl)
{
	pListCtrl->DeleteAllItems();
	pListCtrl->DeleteAllColumns();
}

void CBaseObject::FillListCtrl(CListCtrlEx* pListCtrl)
{
	ShowListCtrl(pListCtrl);
...
void CBaseObject::ShowInTabbedView(CView* pView)
{
	
}
void  CBaseObject::STATData(void)
{
	CBaseObject* pOb;
	POSITION pos=GetFirstChildPosition();
	while (pos)
